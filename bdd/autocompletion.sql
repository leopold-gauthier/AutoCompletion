...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 14 avr. 2023 à 08:35
...
CREATE TABLE IF NOT EXISTS `pokemon` (
  ...
  `Type_1` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Type_2` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  ...
  `Legendary` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
...
INSERT INTO `pokemon` (`id`, `Name`, `Type_1`, `Type_2`, `Total`, `HP`, `Attack`, `Defense`, `Sp_Atk`, `Sp_Def`, `Speed`, `Generation`, `Legendary`) VALUES
